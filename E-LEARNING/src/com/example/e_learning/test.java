...
public class test extends Activity implements OnClickListener{
	private ImageView img_TVol, img_TExer, img_TTest, img_TStory;
	private TextView tvTExer, tvTVol, tvTTest, tvTtest, tvTStory;
	...
	protected void onCreate(android.os.Bundle savedInstanceState) {
		...
		img_TStory = (ImageView)findViewById(R.id.img_TStory);
		img_TStory.setOnClickListener(this);
