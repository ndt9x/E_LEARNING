...
public class E_LEARNING extends Activity implements OnClickListener{
	private ImageButton imgVol, imgExer, imgTest, imgSto;
	...
	public void onClick(View v) {
		...
		case R.id.imgExer:
			...
			break;
		case R.id.imgTest:
			intent =  new Intent(E_LEARNING.this, test.class);
			startActivity(intent);
			finish();
			break;
		case R.id.imgStory:
			intent =  new Intent(E_LEARNING.this, story.class);
			startActivity(intent);
			finish();
			break;
		default:
	...
	void addDbTest(){
		...
		Test test82= new Test("English Test 9","The test …………………. at five o'clock this afternoon.", "is given", "will give", "will given", "will be given", "will be given");
